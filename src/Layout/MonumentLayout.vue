<template class="container-fluid">
    <div v-mdb-resize:start="checkWidth">
        <mdb-side-nav-2 :data="navigation" v-model="show" :over="false" :slimCollapsed="collapse" :isCollapsed="collapsed"  slim :slimWidth="60"
            color="danger darken-4" @hover="() => slimCollapsed = false"
            :sidenav-class="['border-right', 'shadow']"
            @toggleSlim="slimCollapsed = $event">
            <div slot="header" style="margin:100px;">

            </div>

            <mdb-navbar slot="nav" tag="div" position="top"  color="white" class="darken-4" dark :toggler="false"
                :style="{zIndex: '1061' }">
                ...
                <span class="ms-2 collapse navbar-collapse">
                    <div class="d-flex">
        ...
        return{
            ...
            navigation: [
                ...
                // },
                {
                    name: "Menú",
                    icon: "chalkboard",
                    href: `${process.env.VUE_APP_URL}/${this.$route.params.monumentoNombre}/tablero`,
                },
                // {
                //     name: "Reservar/Comprar",
                //     icon: "shopping-cart",
                //     href: `${process.env.VUE_APP_URL}/${this.$route.params.monumentoNombre}/productos`,
                // },
                {
                    name: "Mis reservas",
                    icon: "calendar-check",
                ...
                },
                {
                    name: "Facturas",
                    icon: "file-invoice",
                    href: `${process.env.VUE_APP_URL}/${this.$route.params.monumentoNombre}/invoices`
                },
                {
